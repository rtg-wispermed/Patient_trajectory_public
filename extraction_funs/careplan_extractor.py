...
def getCareplan(json_pat):
    ...
    careplan_ex = extractor(name="PatientCarePlan", resourceType="CarePlan")

    # Note: when you add condition you are already under this so you start path from here
    careplan_ex.addCondition(lambda x: tryPath(x, ['identifier',0,'system']) == 'https://uk-essen.de/HIS/Cerner/Medico/TumorDocumentation/TherapyPlanning')
    ...
    conds = [{'careplan_name':lambda x: tryPath(x, ['category',0,'coding',0,'system']) == 'https://uk-essen.de/HIS/Cerner/Medico/TumorDocumentation/TherapyPlanning/Therapie'},
             {'careplan_intention':lambda x: tryPath(x, ['category',1,'coding',0,'system']) == 'https://uk-essen.de/HIS/Cerner/Medico/TumorDocumentation/TherapyPlanning/Therapieziel'},
             {'careplan_type':lambda x: tryPath(x, ['category',2,'coding',0,'system']) == 'https://uk-essen.de/HIS/Cerner/Medico/TumorDocumentation/TherapyPlanning/Therapieart'} ]
